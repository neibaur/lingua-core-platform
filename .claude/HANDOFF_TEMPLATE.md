...
Status of documented integration path: [SUMMARY OF CONFIRMED EXISTS/GAP STATUS FROM LAST SESSION]
...
Any new slice must result in ≥ [N] + (count of new tests) passing. Existing [N] must remain untouched.
